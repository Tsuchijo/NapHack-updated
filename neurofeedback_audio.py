"""
Estimate Delta, Theta, Alpha and Beta band powers.
Allow flexible mapping of Band Powers to frequency of auditory tone feedback

The code buffer, epoch, and transform EEG data from selected
electrode(s) into values for each of the classic frequency bands (Delta, Theta, Alpha and Beta)
The code also omputes ratios of the band powers which can be used to estimate mental state 
(as mentioned in the cited paper below) for neurofeedback.
